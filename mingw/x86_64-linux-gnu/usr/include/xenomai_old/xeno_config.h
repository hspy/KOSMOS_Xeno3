...
/* Compiler */
#define CONFIG_XENO_COMPILER "gcc version 4.4.5 (Debian 4.4.5-8) "
...
/* config */
#define CONFIG_XENO_REVISION_LEVEL 6
...
/* config */
#define CONFIG_XENO_VERSION_MINOR 5
...
#define PACKAGE_STRING "Xenomai 2.5.6"
