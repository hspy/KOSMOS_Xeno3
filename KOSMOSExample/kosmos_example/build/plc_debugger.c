 ...
 * Declare programs 
 **/
extern PROGRAM0 RESOURCE1__INST_1;
...
{
    (*fp)((void*)&(RESOURCE1__INST_1.LOCALVAR0),INT_ENUM);

    (*fp)((void*)&(RESOURCE1__INST_1.ADD1_OUT),INT_ENUM);
...
__IEC_types_enum __find_variable(unsigned int varindex, void ** varp)
{
    switch(varindex){
    case 1:
        *varp = (void*)&(RESOURCE1__INST_1.LOCALVAR0);
        return INT_ENUM;

    case 2:
        *varp = (void*)&(RESOURCE1__INST_1.ADD1_OUT);
        return INT_ENUM;
