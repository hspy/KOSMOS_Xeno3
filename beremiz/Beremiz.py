...
if __name__ == '__main__':
    ...
    app.SetAppName('KOSMOS_IDE')
    wx.InitAllImageHandlers()
    
    # popup splash
    bmp = wx.Image(Bpath("images", "kosmos_splash.png")).ConvertToBitmap()
...
class Beremiz(IDEFrame):
    ...
    def __init__(self, parent, projectOpen=None, buildpath=None, ctr=None, debug=True):
        ...
        self.SetIcon(wx.Icon(Bpath("images", "kosmos_icon.ico"), wx.BITMAP_TYPE_ICO))
    ...
    def OnAboutMenu(self, event):
        OpenHtmlFrame(self,_("about_kosmos"), Bpath("doc", "about.html"), wx.Size(900, 600))
